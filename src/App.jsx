  ...
  useEffect(()=>{(async()=>{
    ...
    if(salvo){
      ...
      try{
        ...
        else if(atualizado&&atualizado.status==="active"){setUsuario(atualizado);localStorage.setItem("obras_usuario",JSON.stringify(atualizado));if(atualizado.mustChangePassword)setSenhaModal(true)}
